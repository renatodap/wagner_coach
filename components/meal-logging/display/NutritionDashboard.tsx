...
import { getMeals, type Meal } from '@/lib/meal-logging/api/meals';
import { createTemplate } from '@/lib/meal-logging/api/templates';
...
import { calculateDailyTotals, calculateMealTotals, isMealMissingTotals } from '@/lib/meal-logging/utils/nutrition-calculations';
...
export function NutritionDashboard() {
  ...
  const handleDeleteMeal = async (mealId: string) => {
    ...
    try {
      ...
      const { deleteMeal } = await import('@/lib/meal-logging/api/meals');
