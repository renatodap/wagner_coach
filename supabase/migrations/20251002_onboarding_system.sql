...
-- Migration: 20251002_onboarding_system
-- ============================================================
...
ON user_profile_embeddings USING ivfflat (embedding vector_cosine_ops);
...
BEGIN
  IF NEW.completed = TRUE AND OLD.completed = FALSE THEN
    ...
    UPDATE profiles SET onboarding_completed = TRUE WHERE id = NEW.user_id;
  END IF;
  RETURN NEW;
END;
$$ LANGUAGE plpgsql;
